...
public class Block24Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_24")
	public static final Block block = null;
	public Block24Block(ApesStrongTogetherModElements instance) {
		super(instance, 84);
	}
