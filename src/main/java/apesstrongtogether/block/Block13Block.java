...
public class Block13Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_13")
	public static final Block block = null;
	public Block13Block(ApesStrongTogetherModElements instance) {
		super(instance, 76);
	}
