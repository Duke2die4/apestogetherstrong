...
public class Tree1planks2Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_1planks_2")
	public static final Block block = null;
	public Tree1planks2Block(ApesStrongTogetherModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tree_1planks_2");
		}
