...
public class CustomSand2paneBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:custom_sand_2pane")
	public static final Block block = null;
	public CustomSand2paneBlock(ApesStrongTogetherModElements instance) {
		super(instance, 227);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("custom_sand_2pane");
		}
