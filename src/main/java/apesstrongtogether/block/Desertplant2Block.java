...
public class Desertplant2Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:desertplant_2")
	public static final Block block = null;
	public Desertplant2Block(ApesStrongTogetherModElements instance) {
		super(instance, 104);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("desertplant_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:desertplant_2"), configuredFeature);
		}
	}
	@SubscribeEvent
