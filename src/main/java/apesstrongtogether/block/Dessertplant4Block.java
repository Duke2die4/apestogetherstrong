...
public class Dessertplant4Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:dessertplant_4")
	public static final Block block = null;
	public Dessertplant4Block(ApesStrongTogetherModElements instance) {
		super(instance, 220);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dessertplant_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:dessertplant_4"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("dessertplant_4");
		}
