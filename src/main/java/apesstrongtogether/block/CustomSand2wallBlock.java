...
public class CustomSand2wallBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:custom_sand_2wall")
	public static final Block block = null;
	public CustomSand2wallBlock(ApesStrongTogetherModElements instance) {
		super(instance, 226);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("custom_sand_2wall");
		}
