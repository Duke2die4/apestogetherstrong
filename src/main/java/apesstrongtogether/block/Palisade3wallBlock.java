...
public class Palisade3wallBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:palisade_3wall")
	public static final Block block = null;
	public Palisade3wallBlock(ApesStrongTogetherModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("palisade_3wall");
		}
