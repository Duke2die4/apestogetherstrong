...
public class PalisadewallBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:palisadewall")
	public static final Block block = null;
	public PalisadewallBlock(ApesStrongTogetherModElements instance) {
		super(instance, 296);
	}
