...
public class Palisade3paneBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:palisade_3pane")
	public static final Block block = null;
	public Palisade3paneBlock(ApesStrongTogetherModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("palisade_3pane");
		}
