...
public class PallisadewallBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisadewall")
	public static final Block block = null;
	public PallisadewallBlock(ApesStrongTogetherModElements instance) {
		super(instance, 307);
	}
