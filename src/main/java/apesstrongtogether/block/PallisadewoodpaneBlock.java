...
public class PallisadewoodpaneBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisadewoodpane")
	public static final Block block = null;
	public PallisadewoodpaneBlock(ApesStrongTogetherModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pallisadewoodpane");
		}
