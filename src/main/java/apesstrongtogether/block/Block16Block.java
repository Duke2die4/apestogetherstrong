...
public class Block16Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_16")
	public static final Block block = null;
	public Block16Block(ApesStrongTogetherModElements instance) {
		super(instance, 79);
	}
