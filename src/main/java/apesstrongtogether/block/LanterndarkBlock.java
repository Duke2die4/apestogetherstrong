...
import apesstrongtogether.procedures.LanterndarkUpdateTickProcedure;

import apesstrongtogether.ApesStrongTogetherModElements;

@ApesStrongTogetherModElements.ModElement.Tag
public class LanterndarkBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:lanterndark")
	public static final Block block = null;
	public LanterndarkBlock(ApesStrongTogetherModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				LanterndarkUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 200);
		}
	}
