...
import apesstrongtogether.procedures.Block2UpdateTickProcedure;
...
public class Block2Block extends ApesStrongTogetherModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("block_2"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("block_2");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("spawner_test");
		}
