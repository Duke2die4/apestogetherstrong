...
public class Tree2FenceBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_2_fence")
	public static final Block block = null;
	public Tree2FenceBlock(ApesStrongTogetherModElements instance) {
		super(instance, 265);
	}
