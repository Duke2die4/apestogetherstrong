...
public class Block17Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_17")
	public static final Block block = null;
	public Block17Block(ApesStrongTogetherModElements instance) {
		super(instance, 80);
	}
