...
public class Block10Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_10")
	public static final Block block = null;
	public Block10Block(ApesStrongTogetherModElements instance) {
		super(instance, 73);
	}
