...
public class Tree2StairsBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_2_stairs")
	public static final Block block = null;
	public Tree2StairsBlock(ApesStrongTogetherModElements instance) {
		super(instance, 263);
	}
