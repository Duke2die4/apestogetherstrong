...
public class Block15Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_15")
	public static final Block block = null;
	public Block15Block(ApesStrongTogetherModElements instance) {
		super(instance, 78);
	}
