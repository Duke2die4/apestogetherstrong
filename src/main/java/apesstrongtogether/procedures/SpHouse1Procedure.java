...
public class SpHouse1Procedure extends ApesStrongTogetherModElements.ModElement {
	public SpHouse1Procedure(ApesStrongTogetherModElements instance) {
		super(instance, 186);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency x for procedure SpHouse1!");
			return false;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency y for procedure SpHouse1!");
			return false;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency z for procedure SpHouse1!");
			return false;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency world for procedure SpHouse1!");
			return false;
		}
		...
		StructureSizeX = (double) 10;
		StructureSizeZ = (double) 14;
		PositionX = (double) 0;
		PositionZ = (double) 0;
