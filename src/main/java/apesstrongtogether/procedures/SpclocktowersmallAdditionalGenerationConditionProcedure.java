...
public class SpclocktowersmallAdditionalGenerationConditionProcedure extends ApesStrongTogetherModElements.ModElement {
	public SpclocktowersmallAdditionalGenerationConditionProcedure(ApesStrongTogetherModElements instance) {
		super(instance, 183);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency x for procedure SpclocktowersmallAdditionalGenerationCondition!");
			return false;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency y for procedure SpclocktowersmallAdditionalGenerationCondition!");
			return false;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency z for procedure SpclocktowersmallAdditionalGenerationCondition!");
			return false;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ApesStrongTogetherMod.LOGGER.warn("Failed to load dependency world for procedure SpclocktowersmallAdditionalGenerationCondition!");
			return false;
		}
		...
		StructureSizeX = (double) 12;
		StructureSizeZ = (double) 12;
		PositionX = (double) 0;
		PositionZ = (double) 0;
