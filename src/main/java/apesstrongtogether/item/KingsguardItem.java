...
public class KingsguardItem extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:kingsguard_helmet")
	public static final Item helmet = null;
	@ObjectHolder("apes_strong_together:kingsguard_chestplate")
	public static final Item body = null;
	@ObjectHolder("apes_strong_together:kingsguard_leggings")
	public static final Item legs = null;
	@ObjectHolder("apes_strong_together:kingsguard_boots")
	public static final Item boots = null;
	public KingsguardItem(ApesStrongTogetherModElements instance) {
		super(instance, 250);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "apes_strong_together:textures/kings_soldier.png";
			}
		}.setRegistryName("kingsguard_chestplate"));
		...
		}.setRegistryName("kingsguard_leggings"));
		...
		}.setRegistryName("kingsguard_boots"));
	}
