...
import apesstrongtogether.entity.renderer.GorillabruteRenderer;

import apesstrongtogether.ApesStrongTogetherModElements;

@ApesStrongTogetherModElements.ModElement.Tag
public class GorillabruteEntity extends ApesStrongTogetherModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("gorillabrute").setRegistryName("gorillabrute");
	public GorillabruteEntity(ApesStrongTogetherModElements instance) {
		super(instance, 317);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GorillabruteRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14808052, -12310003, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("gorillabrute_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 70, 1, 2));
	}
