...
import apesstrongtogether.procedures.ChestapeironRightClickedOnEntityProcedure;

import apesstrongtogether.gui.GuichestironGui;

import apesstrongtogether.entity.renderer.ChestapeironRenderer;
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GuichestironGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
