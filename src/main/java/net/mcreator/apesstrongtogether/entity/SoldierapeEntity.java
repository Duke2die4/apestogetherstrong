...
import apesstrongtogether.item.ApearmorItem;

import apesstrongtogether.entity.renderer.SoldierapeRenderer;

import apesstrongtogether.ApesStrongTogetherModElements;

@ApesStrongTogetherModElements.ModElement.Tag
public class SoldierapeEntity extends ApesStrongTogetherModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("soldierape").setRegistryName("soldierape");
	public SoldierapeEntity(ApesStrongTogetherModElements instance) {
		super(instance, 276);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SoldierapeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("soldierape_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 70, 4, 8));
	}
