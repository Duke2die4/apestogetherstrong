...
@OnlyIn(Dist.CLIENT)
public class ApeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ApeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelApe(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("apes_strong_together:textures/ape.png");
					}
				};
			});
		}
