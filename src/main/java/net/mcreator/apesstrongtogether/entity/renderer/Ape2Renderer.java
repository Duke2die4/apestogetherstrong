...
public class Ape2Renderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Ape2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelApe2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("apes_strong_together:textures/ape2.png");
					}
				};
			});
		}
	...
	public static class ModelApe2 extends EntityModel<Entity> {
