...
import net.mcreator.apesstrongtogether.entity.Steampunkmob22Entity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class Steampunkmob22Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Steampunkmob22Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsteampunkmob2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("apes_strong_together:textures/steampunkmob2.png");
					}
				};
			});
		}
