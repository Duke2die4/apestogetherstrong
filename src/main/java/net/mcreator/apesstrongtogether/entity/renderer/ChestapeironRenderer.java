...
@OnlyIn(Dist.CLIENT)
public class ChestapeironRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ChestapeironEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelApe2chest(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("apes_strong_together:textures/ape2chestiron.png");
					}
				};
			});
		}
