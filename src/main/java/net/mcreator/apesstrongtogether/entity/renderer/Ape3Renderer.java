...
@OnlyIn(Dist.CLIENT)
public class Ape3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Ape3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelApe3(), 1.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("apes_strong_together:textures/ape3.png");
					}
				};
			});
		}
