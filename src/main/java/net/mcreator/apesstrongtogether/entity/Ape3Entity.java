...
import net.mcreator.apesstrongtogether.entity.renderer.Ape3Renderer;
import net.mcreator.apesstrongtogether.ApesStrongTogetherModElements;

@ApesStrongTogetherModElements.ModElement.Tag
public class Ape3Entity extends ApesStrongTogetherModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ape_3_spawn_egg"));
	}
