...
public class ChestApeEmeraldEntity extends ApesStrongTogetherModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 0.3f)).build("chest_ape_emerald").setRegistryName("chest_ape_emerald");
	public ChestApeEmeraldEntity(ApesStrongTogetherModElements instance) {
		super(instance, 66);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChestApeEmeraldRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		private final ItemStackHandler inventory = new ItemStackHandler(120) {
			@Override
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GuiChestEmeraldGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
