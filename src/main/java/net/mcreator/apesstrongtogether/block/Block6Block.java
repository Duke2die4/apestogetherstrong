...
public class Block6Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_6")
	public static final Block block = null;
	public Block6Block(ApesStrongTogetherModElements instance) {
		super(instance, 70);
	}
