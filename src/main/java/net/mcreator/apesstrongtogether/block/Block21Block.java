...
public class Block21Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_21")
	public static final Block block = null;
	public Block21Block(ApesStrongTogetherModElements instance) {
		super(instance, 87);
	}
