...
public class PalisadepaneBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:palisadepane")
	public static final Block block = null;
	public PalisadepaneBlock(ApesStrongTogetherModElements instance) {
		super(instance, 297);
	}
