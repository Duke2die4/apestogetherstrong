...
public class Customsand1Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:customsand_1")
	public static final Block block = null;
	public Customsand1Block(ApesStrongTogetherModElements instance) {
		super(instance, 203);
	}
