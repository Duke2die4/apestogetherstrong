...
public class Stone1Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:stone_1")
	public static final Block block = null;
	public Stone1Block(ApesStrongTogetherModElements instance) {
		super(instance, 216);
	}
