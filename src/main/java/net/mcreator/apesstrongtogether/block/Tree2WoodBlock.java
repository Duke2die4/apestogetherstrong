...
public class Tree2WoodBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_2_wood")
	public static final Block block = null;
	public Tree2WoodBlock(ApesStrongTogetherModElements instance) {
		super(instance, 259);
	}
