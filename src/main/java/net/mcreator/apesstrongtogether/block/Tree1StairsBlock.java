...
public class Tree1StairsBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_1_stairs")
	public static final Block block = null;
	public Tree1StairsBlock(ApesStrongTogetherModElements instance) {
		super(instance, 232);
	}
