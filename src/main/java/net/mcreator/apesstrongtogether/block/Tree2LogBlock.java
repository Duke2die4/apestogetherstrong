...
public class Tree2LogBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_2_log")
	public static final Block block = null;
	public Tree2LogBlock(ApesStrongTogetherModElements instance) {
		super(instance, 260);
	}
