...
public class PallisadewallmossyBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisadewallmossy")
	public static final Block block = null;
	public PallisadewallmossyBlock(ApesStrongTogetherModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("pallisadewallmossy");
		}
