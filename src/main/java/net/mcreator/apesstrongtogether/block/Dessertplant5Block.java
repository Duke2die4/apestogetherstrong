...
public class Dessertplant5Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:dessertplant_5")
	public static final Block block = null;
	public Dessertplant5Block(ApesStrongTogetherModElements instance) {
		super(instance, 221);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dessertplant_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:dessertplant_5"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("dessertplant_5");
		}
