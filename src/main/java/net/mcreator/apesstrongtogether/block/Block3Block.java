...
public class Block3Block extends ApesStrongTogetherModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("apes_strong_together:block_3_match"),
			...
			event.getRegistry().register(feature.setRegistryName("block_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:block_3"), configuredFeature);
		}
	}
	@SubscribeEvent
