...
public class BananatreeBlock extends ApesStrongTogetherModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bananatree"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:bananatree"), configuredFeature);
		}
	}
	@SubscribeEvent
