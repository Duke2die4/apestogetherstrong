...
public class Ore2Block extends ApesStrongTogetherModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("apes_strong_together:ore_2_match"),
			...
			event.getRegistry().register(feature.setRegistryName("ore_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:ore_2"), configuredFeature);
		}
	}
	@SubscribeEvent
