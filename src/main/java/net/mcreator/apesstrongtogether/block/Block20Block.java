...
public class Block20Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_20")
	public static final Block block = null;
	public Block20Block(ApesStrongTogetherModElements instance) {
		super(instance, 85);
	}
