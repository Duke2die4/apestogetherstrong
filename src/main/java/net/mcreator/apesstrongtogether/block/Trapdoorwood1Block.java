...
public class Trapdoorwood1Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:trapdoorwood_1")
	public static final Block block = null;
	public Trapdoorwood1Block(ApesStrongTogetherModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("trapdoorwood_1");
		}
