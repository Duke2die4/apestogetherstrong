...
public class Pallisade3wallmossyBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisade_3wallmossy")
	public static final Block block = null;
	public Pallisade3wallmossyBlock(ApesStrongTogetherModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("pallisade_3wallmossy");
		}
