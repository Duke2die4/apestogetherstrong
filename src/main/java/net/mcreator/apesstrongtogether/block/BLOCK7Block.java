...
public class BLOCK7Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_7")
	public static final Block block = null;
	public BLOCK7Block(ApesStrongTogetherModElements instance) {
		super(instance, 69);
	}
