...
public class Tree1LogBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_1_log")
	public static final Block block = null;
	public Tree1LogBlock(ApesStrongTogetherModElements instance) {
		super(instance, 229);
	}
