...
public class Block19Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:block_19")
	public static final Block block = null;
	public Block19Block(ApesStrongTogetherModElements instance) {
		super(instance, 82);
	}
