...
public class Tree1FenceBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_1_fence")
	public static final Block block = null;
	public Tree1FenceBlock(ApesStrongTogetherModElements instance) {
		super(instance, 234);
	}
