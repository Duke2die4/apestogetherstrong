...
public class PallisadecrackedwallBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisadecrackedwall")
	public static final Block block = null;
	public PallisadecrackedwallBlock(ApesStrongTogetherModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("pallisadecrackedwall");
		}
