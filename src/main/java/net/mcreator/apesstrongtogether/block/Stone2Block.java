...
public class Stone2Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:stone_2")
	public static final Block block = null;
	public Stone2Block(ApesStrongTogetherModElements instance) {
		super(instance, 217);
	}
