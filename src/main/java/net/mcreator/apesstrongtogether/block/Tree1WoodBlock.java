...
public class Tree1WoodBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:tree_1_wood")
	public static final Block block = null;
	public Tree1WoodBlock(ApesStrongTogetherModElements instance) {
		super(instance, 228);
	}
