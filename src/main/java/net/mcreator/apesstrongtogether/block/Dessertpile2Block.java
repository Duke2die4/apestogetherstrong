...
public class Dessertpile2Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:dessertpile_2")
	public static final Block block = null;
	public Dessertpile2Block(ApesStrongTogetherModElements instance) {
		super(instance, 219);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dessertpile_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:dessertpile_2"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("apes_strong_together:forbidding_flatlands").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("apes_strong_together:burned_flatlands").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
