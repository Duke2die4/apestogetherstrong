...
public class BrickwindowBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:brickwindow")
	public static final Block block = null;
	public BrickwindowBlock(ApesStrongTogetherModElements instance) {
		super(instance, 281);
	}
