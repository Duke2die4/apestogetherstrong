...
public class Doorwood1Block extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:doorwood_1")
	public static final Block block = null;
	public Doorwood1Block(ApesStrongTogetherModElements instance) {
		super(instance, 244);
	}
