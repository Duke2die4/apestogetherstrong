...
public class DesertgrassBlock extends ApesStrongTogetherModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("apes_strong_together:desertgrass_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 28)).range(128)
					.square().func_242731_b(12);
			event.getRegistry().register(feature.setRegistryName("desertgrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("apes_strong_together:desertgrass"), configuredFeature);
		}
	}
	@SubscribeEvent
