...
public class Palisade3fenceBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:palisade_3fence")
	public static final Block block = null;
	public Palisade3fenceBlock(ApesStrongTogetherModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("palisade_3fence");
		}
