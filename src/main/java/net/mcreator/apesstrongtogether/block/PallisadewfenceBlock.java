...
public class PallisadewfenceBlock extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:pallisadewfence")
	public static final Block block = null;
	public PallisadewfenceBlock(ApesStrongTogetherModElements instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("pallisadewfence");
		}
