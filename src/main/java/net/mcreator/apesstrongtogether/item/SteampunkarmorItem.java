...
public class SteampunkarmorItem extends ApesStrongTogetherModElements.ModElement {
	@ObjectHolder("apes_strong_together:steampunkarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("apes_strong_together:steampunkarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("apes_strong_together:steampunkarmor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new Modelsteampunk_ape_armor().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "apes_strong_together:textures/steampunk_ape_armor.png";
			}
		}.setRegistryName("steampunkarmor_helmet"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedBody = new Modelsteampunk_ape_armor().Body;
				armorModel.bipedLeftArm = new Modelsteampunk_ape_armor().LeftArm;
				armorModel.bipedRightArm = new Modelsteampunk_ape_armor().RightArm;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("steampunkarmor_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedLeftLeg = new Modelsteampunk_ape_armor().LeftLeg;
				armorModel.bipedRightLeg = new Modelsteampunk_ape_armor().RightLeg;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("steampunkarmor_leggings"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedLeftLeg = new Modelsteampunk_ape_armor().leftfoot;
				armorModel.bipedRightLeg = new Modelsteampunk_ape_armor().rightfoot;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("steampunkarmor_boots"));
	}
